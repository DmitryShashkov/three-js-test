...
import { Chapter1GuiControls } from '../../models/chapter-1-gui.controls';
...
export class Chapter1Component implements AfterViewInit {
    ...
    private controls: Chapter1GuiControls = {
        rotationSpeed: 0.02,
        bouncingSpeed: 0.03,
    };
    ...
    public ngAfterViewInit (): void {
        ...
        this.stats = Chapter1Component.initStats(this.statsOutput.nativeElement);
